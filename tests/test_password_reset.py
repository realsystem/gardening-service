...
class TestPasswordResetRequest:
    ...
    def test_request_reset_existing_email(self, db: Session, test_user: User):
    ...
    def test_request_reset_nonexistent_email(self, db: Session):
    ...
    def test_request_reset_rate_limiting(self, db: Session, test_user: User):
...
class TestPasswordResetConfirm:
    ...
    def test_confirm_reset_valid_token(self, db: Session, test_user: User):
    ...
    def test_confirm_reset_expired_token(self, db: Session, test_user: User):
    ...
    def test_confirm_reset_used_token(self, db: Session, test_user: User):
    ...
    def test_confirm_reset_weak_password(self, db: Session, test_user: User):
    ...
    def test_confirm_reset_reuse_attempt(self, db: Session, test_user: User):
...
class TestPasswordResetRepository:
    ...
    def test_create_token(self, db: Session, test_user: User):
    ...
    def test_create_token_invalidates_old_tokens(self, db: Session, test_user: User):
    ...
    def test_get_active_token_for_user(self, db: Session, test_user: User):
